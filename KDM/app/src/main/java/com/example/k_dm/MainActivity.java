...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        CountDownTimer CDT = new CountDownTimer(86400 * 1000, 1000) {
            public void onTick(long millisUntilFinished) {
                ...
                if (getTime.equals(xy)){
                    System.out.println("쐇따!!!!!!!!!!!!!!1");
                    ((setting)setting.Context1).sendData("8");
                    hou="XXX";
                    minu="XXX";
                }
                else;
        ...
        hou = shared.getString(Context, "hour");
        minu = shared.getString(Context, "min");
        ...
        button2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intentMain = new Intent(getApplicationContext(), menuActivity.class);
